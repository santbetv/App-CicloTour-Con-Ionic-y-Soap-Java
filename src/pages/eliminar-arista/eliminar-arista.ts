...
@IonicPage()
@Component({
  selector: 'page-eliminar-arista',
  templateUrl: 'eliminar-arista.html',
})
export class EliminarAristaPage {
          ...
          if (protocoloHttp >= 400 && protocoloHttp <= 499) {
            ...
            if (this.resultadoDestino === 0) {
              ...
              if (this.resultadoOrigen === 0) {
                ...
                this.ws.eliminarArista('eliminarArista', this.resultadoOrigen, this.resultadoDestino)
                  .then((respuesta) => {
                    //console.log(respuesta);
                    this.mensajesDeUsuario(respuesta["S:Envelope"]["S:Body"]["ns2:eliminarAristaResponse"].return + " En aplicacion Java");
