...
@IonicPage()
@Component({
  selector: 'page-crear-arista',
  templateUrl: 'crear-arista.html',
})
export class CrearAristaPage {
            ...
            if (this.resultadoDestino === 0) {
              ...
              if (this.resultadoOrigen === 0) {
                ...
                if (postParams.peso === "") {
                  ...
                  if (postParams.peso > 0) {
                    this.ws.crearArista('crearArista', this.resultadoOrigen, this.resultadoDestino, postParams.peso)
                      .then((respuesta) => {
                        //  console.log(respuesta);
                        this.mensajesDeUsuario(respuesta["S:Envelope"]["S:Body"]["ns2:crearAristaResponse"].return + " En aplicacion Java");
